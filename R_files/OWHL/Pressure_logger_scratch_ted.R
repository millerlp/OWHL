...
#dir1 = 'D:/Miller_projects/Electronics/OWHL/20150326_Field_test/Raw_data/15051500.CSV'
dir1 = '/Users/lyman/Dropbox (Byrnes Lab)/ByrnesLab Wave Sensor/~ Sensor Data/20150326_field_deployment/data/'

#files = dir(dir1, pattern = '*.CSV',include.dirs = FALSE, 
#		recursive = FALSE)

df = read.csv(paste0(dir1,'15032900.CSV'),
